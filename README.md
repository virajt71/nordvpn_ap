...
### Single Profile Flow
Each profile consists of two primary services: **Gluetun** (VPN) and **WiFi-AP** (Hotspot). Traffic is routed through dedicated policy routing tables on the host to ensure all connected clients are protected.
